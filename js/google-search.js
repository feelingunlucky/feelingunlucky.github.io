var params = {
	"cx": "013698624663513982866:_8k8qoq6-5k",
	"language": "en",
	"theme": "V2_DEFAULT",
	"uiOptions": {
		"resultsUrl": "",
		...
		"webSearchSafesearch": "google.search.Search.SAFESEARCH_OFF",
	...
	"rawCss": "",
	"loaderPath": "jsapi",
	"cse_token": "APbAYefuP4UBbwbYbmTInuIMYYjhwUfNMg:1510091746807"
};
window.__gcse = window.__gcse || {};
window.__gcse.ct = (new Date).getTime();
window.__gcse.scb = function() {
	var a = window.__gcse;
	a.plainStyle && delete params.rawCss;
	google.search.cse.element.init(params) && ("explicit" != a.parsetags ? "complete" == document.readyState || "interactive" == document.readyState ? (google.search.cse.element.go(), a.callback && a.callback()) : google.setOnLoadCallback(function() {
...
if (!window['google']['loader']) {
    ...
    (function() {
        ...
        google.loader.f = function(a, b, c) {
            if (c) {
                ...
                a.appendChild(d)
            } else "script" == a ? (d = '<script src="' + w(b) + '" type="text/javascript"', (a = y()) && (d += ' nonce="' + w(a) + '"'), document.write(d + ">\x3c/script>")) : "css" == a &&
                (d = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"', (a = y()) && (d += ' nonce="' + w(a) + '"'), document.write(d + "></link>"))
        };
    ...
    google.loader.rfm({
        ":search": {
            ...
            "path": "/api/search/1.0/e58ec880d43cfc659265840a556af195/",
            "js": "default+en.I.js",
            "css": "default+en.css",
            "properties": {
                ":Version": "1.0",
                ":NoOldNames": false,
                ":JSHash": "e58ec880d43cfc659265840a556af195"
            }
        },
        ":language": {
            "versions": {
...
if (window['google'] != undefined && window['google']['loader'] != undefined) {
    if (!window['google']['search']) {
        ...
        google.search.JSHash = 'e58ec880d43cfc659265840a556af195';
        google.search.LoadArgs = 'file\x3dsearch\x26v\x3d1.0\x26hl\x3den\x26async\x3d2\x26style\x3d';
    }
    google.loader.writeLoadTag("script", google.loader.ServiceBase + "/api/search/1.0/e58ec880d43cfc659265840a556af195/default+en.I.js", true);
}